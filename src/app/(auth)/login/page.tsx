...
function LoginForm() {
    ...
    // CHANGED: Return only the inner content (without the outer container div)
    return (
...
// The default export is now a wrapper component that provides Suspense boundary
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-primary flex items-center justify-center p-4">
            {/* Wrapped LoginForm in Suspense with a loading fallback */}
            <Suspense fallback={
